...
一个简易的备忘录系统，支持用户注册、登录以及备忘录的增删改查功能，用于练习spring boot+mybatis，适合初学者 以及大学生课程设计
...
- - 🎯 **练习项目**：专为学习 Spring Boot 和 MyBatis 而创建
- 🏗️ **完整架构**：包含前端、后端、数据库的完整项目结构
- 📚 **学习资源**：适合初学者了解 Spring Boot 项目开发流程
- 🔧 **易于部署**：配置简单，快速上手
